...
def cache_dir() -> Path:
    scobelix_cache_dir = Path(user_cache_dir("scobelix", "scobelix"))
    if not scobelix_cache_dir.is_dir():
        scobelix_cache_dir.mkdir(parents=True)

    return scobelix_cache_dir
